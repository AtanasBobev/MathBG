...
<body style='display:none;' onunload='unload();SpecialServer()' onload="load()">
    ...
    <div class='window' id='SettingsPanel'>
        ...
        <div class='window' id='help'>
            ...
            <b>2.</b> Choose the type of problems that would be generate using the buttons like Addition, Substraction etc.<br>
            <b>3.</b> Next, choose how many problems you would want to be solved by changing All Problems Count field to desired value. Should you want to simulate more problems than actually are going to be given, change Problems Left field; Otherwise leave blank.<br>
            <b>4.</b> Specify Min and Max generate number. If, e.g. you choose min to be 1 and max to be 3, the numbers 1,2,3 are only going to be generate. An example problem would be 2-1=; 2+2; 1-1= etc. This two values specify the range of the generate problems.<br>
            <b>5. </b> Number of elements per problem refers to the numbers used in equation. E.g. 2 elemnts per problem would refer to equation of the sort 1+1; 3 elements per problem would refer to the equation of the sort 3-2+1; 4 elements per problems would refer to the equation of the sort 1+2+3+2= etc.<br>
            6. If you want to specify time per question, use the last field.<br>
            Click Apply, close the window and then press Start<br>
            <center>
                <h1>How to use the Speech tab?</h1>
            </center><br>
            In the Speech tab you can get output and provide input for the math problems. To activate the options, click Speech I/O (input/output) in order to make it turn green. Click Speech Input option means that if you enable microphone permissions, evey time a new problem is generated, you can say it out loud and the API will detect it and enter the data for you. Speech output is going to play a tone, indicating a solved problem through the current speaker/headphone configuration.
            <br><br>
            <center>
                <h1>How to use the Behavior tab?</h1>
            </center><br>
            In the behavior tab, you can specify the action in specific situation. To change an option click the drop-down and select the option that suits you better.
            <br><br>
            <center>
                <h1>How to use the Print tab?</h1>
            </center><br>
            If you would like to print a hard or a soft copy of the problems, you can use this tab. It is very similar to the general tab. Enter the problems paramters and the number of problems in the field "All Problems". Next, click Generate. Three new buttons should appear. In case of an error, change the values. Clicking Print would open a dialog box to print the problems. If you would like to further modify the format, go to Advanced Print, where you can change the size of the text with values 1-7 with 1 the biggest and 7, the smallest. You can also print the problems' answers to answersheet. Use the clear button to clear the data in the preview field.
            <br><br>
            <center>
        ...
        <div id='advancedPrint'>
            <center>
                <fieldset>
                    ...
                    <input value='Start' class="settings et">
                </fieldset>
                <fieldset>
                    <legend>Custom footer</legend>
                    <input value='End' class="settings et">
                </fieldset>
                <fieldset>
...
document.querySelector("#theme").innerText='Тъмна';
  ...
  document.querySelector("#theme").innerText='Светла';
               ...
               $('#url:text').attr('placeholder', 'Линк');
                    ...
                    document.querySelector("#instrumentPanel > div:nth-child(3) > p").innerText = 'Максимално генериарно число';
                    document.querySelector("#instrumentPanel > div:nth-child(4) > p").innerText = 'Минимално генериарно число';
                    ...
                    document.querySelector("#general > fieldset:nth-child(5) > legend").innerText = 'Максимално генериарно число';
  ...
  document.querySelector("#theme").innerText='White';
        ...
        const changeTheme = () => {
            if (currentTheme === 'dark') {
              ...
              if(currentLang=='en'){
                document.querySelector("#theme").innerText = 'Dark';
                console.log("Button changed to dark");
              }else{
                document.querySelector("#theme").innerText = 'Тъмна';
                console.log("Button changed to Тъмен");
            ...
            if (document.getElementById('AllCount').value == '' || document.getElementById('Solved').value == '' || document.getElementById('MaxGen').value == '' || document.getElementById('MinGen').value == '') {
                ...
                if (document.querySelector("#AllCount").value <= 0 || ((document.querySelector("#AllCount").value) % 1 !== 0) || document.querySelector("#Solved").value <= 0 || document.querySelector("#Solved").value % 1 !== 0 || document.querySelector("#MaxGen").value % 1 !== 0 || document.querySelector("#MaxGen").value <= 0 || document.querySelector("#MinGen").value <= 0 || document.querySelector("#MinGen").value % 1 !== 0 || document.querySelector("#elements").value % 1 !== 0) {
                    if (currentLang == 'en') {
                        ...
                        alertify.alert('Грешка', 'Всички въведени данни трябва да бъдат над 0 и цели числа');
                ...
                if (Number(document.querySelector("#elements").value) > 1 && Number(document.querySelector("#elements").value) < 160) {
                    ...
                    if (Number(document.querySelector("#instrumentPanel > div:nth-child(3) > input").value) <= Number(document.querySelector("#instrumentPanel > div:nth-child(4) > input").value)) {
                        if (currentLang == 'en') {
                            ...
                            alertify.alert('Грешка', 'Уверете се, че максимално генериарно число е по-голямо от минимално генерирано число.');
                        }
                        return;
                    }
                    ...
                    if (Number(document.getElementById('AllCount').value) >= Number(document.getElementById('Solved').value)) {
